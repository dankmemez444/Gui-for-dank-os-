; ==================================================================
; DAnkOS GUI -- The Mike Operating System kernel yes it is based of mike os
; Copyright (C) 2006 - 2014 MikeOS Developers --well yes but some is mine  
;so Copy Right (C)  Dank OS gui Team 2017- 217000000
...
option_screen:
	...
	os_init_msg		db 'Welcome to Dank OS GUi', 0
	os_version_msg		db ' All credit to the maker of mike os  mike os Druaga sYstem  ', MIKEOS_VER, 0
